...
export default function App() {
  ...
  const baseWaterMl = (appData.weight || 60) * 35;
  let bonusWaterMl = 500;
  if (appData.activeGoalType === 'marathon') bonusWaterMl = 1000;
  else if (appData.activeGoalType === 'bulk' || appData.activeGoalType === 'dirty') bonusWaterMl = 750;

  const targetWaterMl = baseWaterMl + bonusWaterMl;
  ...
  return (
    <div className="mobile-frame">
      <div className="screen-container">
          ...
          <div className="screen active">
            ...
            <div className="card">
              ...
              <div className="water-box">
                <div>
                  <div style={{ fontSize: '12px', fontWeight: 800, color: 'var(--water)' }}><i className="fa-solid fa-glass-water"></i> Daily Water Target</div>
        ...
        {activeTab === 'progress' && (
          <div className="screen active">
            <h3 style={{ fontSize: '18px', fontWeight: 800, textAlign: 'center', marginBottom: '14px' }}>Biometrics & Progress</h3>
...
console.log('Dynamic water targets successfully updated!');
