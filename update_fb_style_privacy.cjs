  ...
  return (
    <div className="mobile-frame" style={{ maxWidth: '480px', margin: '0 auto', background: '#f8fafc', minHeight: '100vh', position: 'relative' }}>
      <div className="screen-container" style={{ padding: '16px', paddingBottom: '120px' }}>
        ...
        {/* TAB 3: SOCIAL COMMUNITY FEED (COMPACT FB-STYLE PRIVACY SELECTOR) */}
        {activeTab === 'community' && (
          <div className="screen active">
            <div style={{ marginBottom: '16px' }}>
            ...
            <div className="card" style={{ padding: '16px', borderRadius: '20px', boxShadow: '0 4px 20px rgba(0,0,0,0.05)', marginBottom: '16px' }}>
              <div style={{ display: 'flex', gap: '10px', alignItems: 'center', marginBottom: '12px' }}>
                ...
                <div>
                  ...
                  {/* COMPACT FB STYLE PRIVACY BADGE DROPDOWN */}
                  <select 
                    value={postVisibility} 
                    onChange={e => setPostVisibility(e.target.value)}
                    style={{ background: '#f1f5f9', border: '1px solid #cbd5e1', borderRadius: '12px', padding: '2px 8px', fontSize: '10px', fontWeight: 700, color: '#475569', marginTop: '2px', cursor: 'pointer' }}
                  >
        ...
        {/* TAB 6: PROFILE WITH COMPACT FB STYLE PRIVACY BADGE */}
        {activeTab === 'profile' && (
          <div className="screen active">
            ...
            {/* COMPACT CREATE POST BOX IN PROFILE */}
            <div className="card" style={{ padding: '16px', borderRadius: '20px', boxShadow: '0 4px 20px rgba(0,0,0,0.05)', marginBottom: '16px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
...
console.log('Compact FB Style Privacy Selector deployed!');
