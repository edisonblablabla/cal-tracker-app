...
export default function App() {
  ...
  const createPost = async () => {
    if (!postText.trim() && !imagePreview) return alert('Please enter text or select an image.');
...
console.log('Image compression and fast post publishing feature deployed!');
