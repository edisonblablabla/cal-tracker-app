...
export default function App() {
  ...
  const [showPairModal, setShowSettingsModalPair] = useState(false);
      ...
      {showWatchModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl max-w-md w-full p-6 text-center">
            <h3 className="text-xl font-bold mb-4">Smartwatch Sync</h3>
            <p className="text-gray-600 mb-6">Scanning for nearby fitness devices (Garmin, Apple Watch, Fitbit)...</p>
            <div className="flex justify-center gap-3">
              <button onClick={() => setShowWatchModal(false)} className="px-4 py-2 bg-gray-200 rounded-lg">Cancel</button>
              <button onClick={() => { alert("Device Connected!"); setShowWatchModal(false); }} className="px-4 py-2 bg-indigo-600 text-white rounded-lg">Connect</button>
            </div>
          </div>
        </div>
      )}
  ...
  const confirmWatchPairing = () => {
    ...
    setTimeout(() => {
      ...
      setShowSettingsModalPair(false);
      ...
      <div className="screen-container" style={{ padding: '16px', paddingBottom: '120px' }}>
        ...
        {activeTab === 'home' && (
          <div className="screen active">
            ...
            {/* DYNAMIC SMARTWATCH BIOMETRICS CARD */}
            {!isConnected ? (
              <div className="card" style={{ padding: '20px 16px', borderRadius: '20px', background: '#0f172a', border: '2px dashed #334155', color: 'white', marginBottom: '16px', textAlign: 'center' }}>
                ...
                <button 
                  onClick={() => setShowSettingsModalPair(true)}
              ...
              <div style={{ position: 'fixed', inset: 0, background: 'rgba(15, 23, 42, 0.65)', backdropFilter: 'blur(4px)', zIndex: 2000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px' }}>
                <div className="card" style={{ width: '100%', maxWidth: '360px', padding: '20px', borderRadius: '24px', background: '#ffffff', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.2)' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
                    ...
                    <button onClick={() => setShowSettingsModalPair(false)} style={{ background: '#f1f5f9', border: 'none', borderRadius: '50%', width: '28px', height: '28px', cursor: 'pointer' }}>✕</button>
                  </div>
        ...
        {/* TAB 7: ADMIN MODERATION PANEL WITH USER MANAGEMENT */}
        {isAdmin && activeTab === 'admin' && (
          <div className="screen active">
            <div style={{ marginBottom: '12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                <h3 style={{ fontSize: '20px', fontWeight: 900, color: '#dc2626' }}>🛡️ Admin Dashboard</h3>
