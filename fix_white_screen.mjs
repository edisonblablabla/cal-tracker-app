...
const cleanCode = `import React, { useState, useEffect, useRef } from "react";
  ...
  useEffect(() => {
    if (activeTab === "home" && "geolocation" in navigator) {
      const watchId = navigator.geolocation.watchPosition(
        ...
        (error) => {
          setGpsStatus("Allow Location Permission");
        },
      ...
      <div className="screen-container" style={{ padding: "16px", paddingBottom: "120px" }}>
        ...
        {activeTab === "home" && (
          <div className="screen active">
            ...
            {/* GPS LOCATION & STEP TRACKER CARD */}
...
fs.writeFileSync("src/App.jsx", cleanCode);
