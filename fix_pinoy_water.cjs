...
export default function App() {
  ...
  // PINOY-CALIBRATED SAFE WATER CALCULATION (1.5L to 2.5L Range)
  const baseWaterMl = (appData.weight || 60) * 30; // 30ml per kg for Asian/Pinoy baseline
  ...
  // STRICT PINOY SAFETY CAP: MIN 1500ml, MAX 2500ml (1.5L to 2.5L)
...
console.log('Pinoy water standards applied successfully!');
