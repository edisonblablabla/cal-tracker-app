...
export default function App() {
  ...
  return (
    <div className="mobile-frame">
          ...
          <div className="screen active" style={{ paddingBottom: '70px' }}>
            <div className="card" style={{ padding: 0, overflow: 'hidden', borderRadius: '24px', marginBottom: '16px', position: 'relative' }}>
              <div style={{ 
                ...
                <button 
                  ...
                  style={{ position: 'absolute', top: '12px', right: '12px', background: 'rgba(255,255,255,0.25)', backdropFilter: 'blur(4px)', color: 'white', border: 'none', width: '34px', height: '36px', borderRadius: '10px', cursor: 'pointer', fontSize: '16px' }}
                >
                  <i className="fa-solid fa-ellipsis-vertical"></i>
                </button>
              </div>
              <div style={{ padding: '0 16px 16px 16px', marginTop: '-40px', textAlign: 'center' }}>
                <div style={{ width: '76px', height: '76px', borderRadius: '50%', background: '#ffffff', padding: '4px', margin: '0 auto 8px auto', boxShadow: '0 4px 15px rgba(0,0,0,0.1)', overflow: 'hidden' }}>
                  {appData.avatarUrl ? (
            ...
            {showSettingsModal && (
              <div style={{ position: 'fixed', inset: 0, background: 'rgba(15, 23, 42, 0.6)', backdropFilter: 'blur(4px)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
                <div className="card" style={{ width: '100%', maxWidth: '340px', padding: '20px', borderRadius: '24px', background: '#ffffff', maxHeight: '90vh', overflowY: 'auto' }}>
      ...
      {/* OPTIMIZED TAB ORDER NAVIGATION BAR */}
...
console.log('Tab order updated to Home -> Diary -> Social -> Progress -> Goals -> Profile');
