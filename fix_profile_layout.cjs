  ...
  return (
    <div className="mobile-frame" style={{ maxWidth: '480px', margin: '0 auto', background: '#f8fafc', minHeight: '100vh', position: 'relative' }}>
      <div className="screen-container" style={{ padding: '16px', paddingBottom: '120px' }}>
        ...
        {/* TAB 6: PROFILE (CLEAN PROPORTION & OVERLAP FIX) */}
        {activeTab === 'profile' && (
          <div className="screen active">
            ...
            {/* SETTINGS MODAL WITH CUSTOM FILE BUTTONS & CLEARANCE */}
            {showSettingsModal && (
...
console.log('Profile Overlap and File Upload styling completely fixed!');
