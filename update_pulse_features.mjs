...
// 3. Inject Pulse Section with Notes & Stories into Community/Pulse Tab
const oldCommunitySection = /{activeTab === "community" && \(/;

const newPulseSection = `{activeTab === "community" && (
          <div className="screen active">
            ...
            <div style={{ marginBottom: "14px" }}>
              ...
              <div style={{ display: "flex", gap: "8px", overflowX: "auto" }}>
                {/* ADD STORY BUTTON */}
                <div style={{ minWidth: "75px", height: "100px", borderRadius: "12px", background: "linear-gradient(135deg, #1e293b, #0f172a)", color: "white", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", cursor: "pointer", border: "1px dashed #64748b" }} onClick={() => alert("Story photo picker ready!")}>
...
if (code.includes('{activeTab === "community" && (')) {
  code = code.replace(oldCommunitySection, newPulseSection);
}

fs.writeFileSync('src/App.jsx', code);
console.log('✅ Pulse Tab with Daily Notes and Stories successfully installed!');
