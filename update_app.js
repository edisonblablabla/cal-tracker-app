...
export default function App() {
  ...
  }, [appData.fastingActive, appData.fastStartTime, appData.fastingPlan, appData.notifiedComplete]);
      ...
      <div className="screen-container">
          ...
          <div className="screen active">
            ...
            <div className="fasting-box">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                <div>
                  <span style={{ fontSize: '11px', opacity: 0.7, textTransform: 'uppercase', fontWeight: 800 }}>⏱️ Intermittent Fasting</span>
            ...
            <div className="mode-toggle">
              ...
              <button className={"mode-btn " + (appData.dayMode === 'workout' ? 'active' : '')} onClick={() => setDayMode('workout')}>🏋️ Active Day</button>
            </div>
        ...
        {activeTab === 'goals' && (
          <div className="screen active">
            ...
            <div className="goal-section-header">🏋️ Gym & Weightlifting Goals</div>
            ...
            <div className={"goal-card-option " + (appData.activeGoalType === 'maint' ? 'selected' : '')} onClick={() => setGoalPreset('maint')}>
              <div style={{ fontSize: '13px', fontWeight: 800 }}>⚖️ Weight Maintenance</div>
            ...
            <div className="disclaimer-card">
              <strong>⚠️ Health Disclaimer:</strong> Calorie and macronutrient goals are informational estimates only and do not replace professional medical advice. Consult a healthcare provider before attempting aggressive calorie deficits or new fitness regimens.
            </div>
          </div>
        )}
        ...
        {activeTab === 'profile' && (
          <div className="screen active">
            <div style={{ textAlign: 'center', padding: '10px 0' }}>
              <div style={{ width: '70px', height: '70px', borderRadius: '50%', background: 'var(--primary)', margin: '0 auto 8px auto', display: 'flex', itemsAlign: 'center', justifyContent: 'center', color: 'white', fontSize: '28px' }}><i className="fa-solid fa-user"></i></div>
