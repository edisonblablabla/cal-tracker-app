...
export default function App() {
  ...
  // SOCMED & COMMUNITY STATES WITH PRIVACY TOGGLE
  ...
  const createPost = async () => {
    ...
    try {
      const newPost = {
        ...
        visibility: postVisibility, // 'public' or 'private'
        likes: 0,
        likedBy: [],
        createdAt: Date.now()
      };
  ...
  // FILTER POSTS FOR COMMUNITY (ONLY PUBLIC POSTS OF ALL USERS)
  const publicCommunityPosts = posts.filter(p => p.visibility !== 'private');

  // FILTER POSTS FOR PROFILE (ALL USER'S POSTS: PUBLIC + PRIVATE)
      ...
      <div className="screen-container">
        ...
        {activeTab === 'community' && (
          <div className="screen active" style={{ paddingBottom: '70px' }}>
            ...
            {/* CREATE POST CARD WITH PRIVACY TOGGLE */}
            ...
            <div>
              {publicCommunityPosts.length === 0 ? (
                <div style={{ textAlign: 'center', padding: '40px 20px', color: 'var(--text-muted)' }}>
                  ...
                  <p style={{ fontSize: '12px', fontWeight: 600 }}>No public posts yet in the feed.<br />Be the first athlete to share your progress!</p>
                </div>
              ) : (
        ...
        {/* PROFILE TAB SHOWING ALL USER'S POSTS (WITH VISIBILITY BADGE) */}
        {activeTab === 'profile' && (
          <div className="screen active" style={{ paddingBottom: '70px' }}>
            <div className="card" style={{ padding: 0, overflow: 'hidden', borderRadius: '24px', marginBottom: '16px', position: 'relative' }}>
              <div style={{ height: '90px', background: 'linear-gradient(135deg, #4f46e5, #818cf8)', position: 'relative' }}>
                <button 
            ...
            <div className="card" style={{ padding: '16px', borderRadius: '20px', marginBottom: '16px' }}>
              ...
              {myPosts.length === 0 ? (
                <p style={{ fontSize: '11px', color: 'var(--text-muted)', textAlign: 'center', padding: '20px 0' }}>You haven't posted anything to your gallery yet.</p>
            ...
            {showSettingsModal && (
              <div style={{ position: 'fixed', inset: 0, background: 'rgba(15, 23, 42, 0.6)', backdropFilter: 'blur(4px)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
                <div className="card" style={{ width: '100%', maxWidth: '340px', padding: '20px', borderRadius: '24px', background: '#ffffff' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
                    <h4 style={{ fontSize: '15px', fontWeight: 900 }}>User Profile Settings</h4>
...
console.log('Post privacy controls successfully added!');
