  ...
  return (
    <div className="mobile-frame">
      <div className="screen-container">
        ...
        {/* SOCMED PROFILE TAB (WITH SETTINGS GEAR MODAL) */}
        {activeTab === 'profile' && (
          <div className="screen active" style={{ paddingBottom: '70px' }}>
            {/* PROFILE HEADER / BANNER WITH SETTINGS ICON IN TOP RIGHT */}
...
console.log('Profile settings converted into top-right modal!');
